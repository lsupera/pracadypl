...
public class Controller {
    ...
    public class FileButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            JFileChooser jfc = new JFileChooser(lastPath == null ? FileSystemView.getFileSystemView().getHomeDirectory() : new File(lastPath) );
            ...
            if (returnValue == JFileChooser.APPROVE_OPTION) {
                ...
                mainFrame.addFilePanel(content.getVars(), new ListSelection());
